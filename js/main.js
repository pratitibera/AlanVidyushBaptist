...
var close_collapsibleSidebar = document.getElementById(
  "close_collapsibleSidebar"
);
...
$("#collapsibleBlogCategories .row > div").click(function () {
  ...
  if (
    blog_select_id.split("_")[1] == "0" ||
    blog_select_id.split("_")[1] == "1"
  ) {
    getAllBlogs();
  } else {
    document.location.href =
      "category.html?category=" + blog_select_id.split("_")[1];
  }
});
...
function getFeaturedBlogs() {
  ...
  request.open(
    urlSet.get_featuredblogApi.method,
    urlSet.get_featuredblogApi.url + "?index=0&limit=5",
    true
  );
