      ...
      <div className="container-fluid p-0 pt-5 pr-sm-5 pl-sm-5 pt-sm-5">
        ...
        >
          ...
          <div className="row m-0 d-flex flex-row-reverse">
            ...
            <div className="col-10 col-sm-9 m-auto bluetext fw-600 mfo-13">
              Studied{" "}
              <b>
                Sports Nutritionist Specialist at the National Exercise & Sports
        ...
        >
          ...
          <div className="row m-0 d-flex flex-row-reverse">
            ...
            <div className="col-10 col-sm-9 m-auto bluetext fw-600 mfo-13">
              Studied the <b>Company Secretary’s</b> Course at the Institute of
              Company Secretary of India(ICSI)
            </div>
          </div>
          <div className="row m-0">
            <div className="col-2 col-sm-3">
            ...
            <div className="col-10 col-sm-9 m-auto bluetext fw-600 mfo-13">
              Studied the <b>Financial Literacy Intensive Programme(FLIP)</b> by{" "}
              <b>EIFS</b>
            </div>
          </div>
          <div className="row m-0 d-flex flex-row-reverse">
            ...
            <div className="col-10 col-sm-9 m-auto bluetext fw-600 mfo-13">
              Studied the <b>Financial Literacy Awareness Programme(FLAP)</b> by{" "}
              <b>EIFS</b>
            </div>
          </div>
          <div className="row m-0">
        ...
        >
          <div className="row m-0">
            ...
            <div className="col-10 col-sm-9 m-auto bluetext fw-600 mfo-13">
              Studied and appeared for <b>ICSE</b> and <b>ISC</b> examination at{" "}
              <b>St. Xavier’s Collegiate School</b>
            </div>
          </div>
          <div className="row m-0 d-flex flex-row-reverse">
            <div className="col-2 col-sm-3">
        ...
        >
          <div className="fo-18 mfo-12">
            <b>Disclaimer -</b>Kindly note that having studied a module offered
            by an organisation or an institution doesn’t necessarily signify
            that Alan Baptist is certified in the course corresponding to the
            modules studied.
          </div>
        </div>
      </div>
