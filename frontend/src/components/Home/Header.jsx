      ...
      >
        <div className="row m-0">
          <div className="col-8 col-sm-6 text-left">
            <div className="font-italic fo-26 mfo-16 lfo-20">
              Fitness & Nutrition Coach, Therapist, Educator and Entrepreneur.
            </div>
            <div className="fo-18 mfo-12 mt-4 mlh-19 lfo-12">
              India’s First <span className="bco">Optimum Wellness Coach</span>,
              Alan Baptist is a young <span className="bco">entrepreneur</span>{" "}
              with a powerful vision of <span className="bco">empowering</span>{" "}
              individuals by positively{" "}
              <span className="bco">transforming</span> various aspects of their
            ...
            <div className="row d-none d-sm-flex mt-4 mt-sm-5 collabs">
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={QrImage} className="w-100" alt="Brand1" />
                </a>
              </div>
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={TOIImage} className="w-100" alt="Brand2" />
                </a>
              </div>
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={RediffImage} className="w-100" alt="Brand3" />
                </a>
              </div>
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={MXPImage} className="w-100" alt="Brand4" />
                </a>
              </div>
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={FEImage} className="w-100" alt="Brand5" />
                </a>
              </div>
              <div className="col-sm-4">
                <a
                  ...
                  rel="noreferrer"
                >
                  <img src={IEImage} className="w-100" alt="Brand6" />
                </a>
              </div>
            </div>
          </div>
